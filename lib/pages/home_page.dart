    ...
    borderRadius: const BorderRadius.only(
      ...
      bottomRight: Radius.circular(60),
                    ...
                    padding: const EdgeInsets.only(
                        top: 80, left: 40, right: 20, bottom: 30),
                    child: Row(
                  ...
                  Transform.translate(
                    ...
                    child: Padding(
                      ...
                      child: GridView.count(
                        ...
                        children: [
                        _buildSoftCard(
                            context, 'AI陪伴', 'assets/images/record.jpg', const AIChatPage(), isBlue: false),
                             _buildSoftCard(
                            context, '心理测评', 'assets/images/test.jpg', const AssessmentPage(), isBlue: true),
                             _buildSoftCard(
                            context, '资源推荐', 'assets/images/resource.jpg', const ResourcePage(), isBlue: true),
                        _buildSoftCard(
                            context, '社区交流', 'assets/images/community.jpg', const CommunityPage(), isBlue: false),
...
decoration: BoxDecoration(
  ...
  boxShadow: [
    BoxShadow(
      ...
      child: Row(
        children: [
          const Icon(Icons.music_note, color: Color(0xFF6F99BF), size: 32),
          ...
          IconButton(
            icon: const Icon(Icons.play_arrow_rounded,
                color: Color(0xFF6F99BF), size: 36),
            onPressed: () {
              // TODO: 播放逻辑
            },
          ),
