...
class _CounselorPageState extends State<CounselorPage> {
  ...
  AppBar _buildAppBar(CounselorViewModel vm) {
    return AppBar(
      titleSpacing: 30,
      title: const Text(
        '心理咨询师预约',
  ...
  Widget _buildBody(CounselorViewModel vm) {
  ...
  Widget _buildCounselorCard(Map<String, dynamic> c) {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => ConsultantDetailPage(consultantId: c['id']),
          ),
        );
      },
      child: Card(
